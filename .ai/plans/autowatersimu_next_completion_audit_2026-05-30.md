...
1. Build the full old-vs-worker numerical baseline matrix for ASM1Slim, ASM1, ASM3, UDM single-model, UDM Hybrid multi-model, and Petersen tutorial flows.

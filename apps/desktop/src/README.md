...
6. Project controls call Rust registry/package export/import commands only after dialog path selection; React must not create local project files, decode package file contents, or mutate SQLite directly.

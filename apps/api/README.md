...
- model catalog snapshot registration/read/list query, default parameter set status transition, default parameter set promotion planning, benchmark case job scheduling, and model run persistence/list/search/read query。

...
- evidence governance summary for model/parameter production-readiness review, using the source job tenant/project/site to select scoped persisted model catalog snapshots。

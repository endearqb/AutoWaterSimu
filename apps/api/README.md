...
- token-scoped tenant/project/site read filtering for job list/get, process_graph get, simulation_input get, draft confirmation get / constraint plan / promotion, persisted model catalog root/model/snapshot reads, model_run get / job-filtered list, benchmark_run get / job-filtered list, and artifact download; plus model catalog registration/status, benchmark_run registration, and explicit process_graph/simulation_input registry POST mutation data-scope checks。

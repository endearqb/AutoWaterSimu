...
- selected mutation audit event envelopes for job create/queue, draft confirmation, draft promotion and benchmark schedule-run job creation, artifact retention delete/archive, result explanation submit/review/publish, non-job-scoped model governance mutations, and simulation registry registration mutations。

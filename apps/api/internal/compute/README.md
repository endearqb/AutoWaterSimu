...
- Model catalog snapshot registration/read/list endpoints, default parameter set status transitions, read-only default parameter set promotion plans, and benchmark case job scheduling。

...
- 已稳定的 artifact retention policy 解析、候选判断、retention sweep action planning 和 archive metadata projection 规则。
...
| `artifacts/` | artifact retention policy parsing, candidate checks, sweep action planning, and archive metadata projection helpers |

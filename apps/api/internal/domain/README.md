...
- 已稳定的 `model_run.v1` 字段、evidence refs、warnings 解析规则，以及 default parameter set status 常量和迁移不变量。
...
| `models/` | model_run raw JSON field/ref/warning helpers and parameter-set status invariants |

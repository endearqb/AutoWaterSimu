...
- HTTP response / `contract_error.v1` 映射。
- 生成 OpenAPI 或多语言类型。
...
| 文件 | 作用 |
|---|---|
| `validator.go` | Schema file registry, validator, schema_version mapping, and platform validation errors |
| `validator_test.go` | Direct schema mapping and validation tests |

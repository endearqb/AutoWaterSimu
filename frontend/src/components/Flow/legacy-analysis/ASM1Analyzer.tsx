  ...
  return (
    <Box w="full" h="full" p={4} overflowY="auto">
      {/* <Flex justifyContent="space-between" alignItems="center" mb={4}>
        <Heading size="lg">ASM1计算结果分析</Heading>
        {showCloseButton && (
      ...
      >
        ...
        <Tabs.Content value="tab-0">
          <DataQualityPanel resultData={resultData} modelType="asm1" />
        </Tabs.Content>

        <Tabs.Content value="tab-1">
          <SpatialProfilePanel resultData={resultData} modelType="asm1" />
        </Tabs.Content>

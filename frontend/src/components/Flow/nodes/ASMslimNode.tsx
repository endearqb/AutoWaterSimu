...
interface ASMslimNodeData extends Record<string, unknown> {
  label?: string
  volume?: string | number
  dissolvedOxygen?: string | number
  cod?: string | number
  nitrateNitrogen?: string | number
  ammoniaNitrogen?: string | number
  totalAlkalinity?: string | number
}

interface ASMslimNodeProps extends NodeProps<any> {
  store?: () => RFState
}
...
export default memo(ASMslimNode)

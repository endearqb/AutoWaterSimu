...
export type SimulationRequest = {
    ...
    source_system: string;
    requested_by: string;
    job_type: 'simulation.material_balance.v1' | 'simulation.asm1slim.v1' | 'simulation.asm1.v1' | 'simulation.asm3.v1' | 'simulation.udm.v1' | 'simulation.udm_network.v1';
    input_ref: {
        process_graph_id?: string;
        process_graph_version?: number;
        simulation_input_id?: string;
...
export type job_type = 'simulation.material_balance.v1' | 'simulation.asm1slim.v1' | 'simulation.asm1.v1' | 'simulation.asm3.v1' | 'simulation.udm.v1' | 'simulation.udm_network.v1';

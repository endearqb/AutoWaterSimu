...
export class DefaultService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns UDMHybridValidationResponse UDM hybrid validation result
     * @throws ApiError
     */
    public static validateUdmHybridConfig(data: ValidateUdmHybridConfigData): CancelablePromise<ValidateUdmHybridConfigResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/udm-hybrid-configs/validate',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                400: 'Contract error',
     ...
     * @param data The data for the request.
     * @param data.jobId
     * @returns ProductionReadinessReport Read-only production readiness report
     * @throws ApiError
     */
    public static getComputeJobProductionReadiness(data: GetComputeJobProductionReadinessData): CancelablePromise<GetComputeJobProductionReadinessResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/compute/jobs/{job_id}/production-readiness',
            path: {
                job_id: data.jobId
            },
            errors: {
     ...
     * @param data.limit
     * @param data.cursor
     * @returns ListModelCatalogSnapshotsResponse Persisted model catalog snapshots
     * @throws ApiError
     */
    public static listModelCatalogSnapshots(data: ListModelCatalogSnapshotsData = {}): CancelablePromise<ListModelCatalogSnapshotsResponse2> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/model-catalog/snapshots',
            query: {
     ...
     * @throws ApiError
     */
    public static getDefaultParameterSetPromotionPlan(data: GetDefaultParameterSetPromotionPlanData): CancelablePromise<GetDefaultParameterSetPromotionPlanResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/model-catalog/{model_key}/versions/{model_version}/default-parameter-set/promotion-plan',
            path: {
                model_key: data.modelKey,
                model_version: data.modelVersion
            },
     ...
     * @param data.requestBody
     * @returns JobSnapshot Duplicate benchmark case run idempotency key
     * @returns JobSnapshot Queued benchmark case compute job
     * @throws ApiError
     */
    public static scheduleBenchmarkCaseRun(data: ScheduleBenchmarkCaseRunData): CancelablePromise<ScheduleBenchmarkCaseRunResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/model-catalog/{model_key}/versions/{model_version}/benchmark-cases/{benchmark_case_id}/schedule-run',
            path: {
                model_key: data.modelKey,
                model_version: data.modelVersion,

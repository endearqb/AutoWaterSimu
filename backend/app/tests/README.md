...
4. backend material_balance thin-shell leaf migration 应优先补 class identity 或 parity guard，避免仅靠 import 成功判断迁移完成；exception leaf 与 result model leaf 均需由 focused tests 固定。

...
class ASM1SlimService:
    ...
    async def run_calculation(
        ...
        try:
            ...
            logger.info(
                "asm1slim calculation completed",
                extra={
                    "job_id": job_id,
            ...
            logger.warning("asm1slim calculation cancelled", extra={"job_id": job_id})

...
| `ci/` | AutoWaterSimu Next PR fast、opt-in integration smoke、opt-in security smoke、mock-backed browser smoke、live backend browser smoke、Desktop package smoke 与 golden scenario evidence 汇总/刷新脚本 |

...
$report = [ordered]@{
    ...
    notes = @(
        ...
        "The package movement guardrail expects platform helpers under apps/api/internal/platform, artifact retention policy helpers under apps/api/internal/domain/artifacts, jobs status and claim matching invariants under apps/api/internal/domain/jobs, model_run parsing helpers under apps/api/internal/domain/models, and worker lifecycle under apps/api/internal/domain/workers.",

...
Invoke-Step -Name "auth scope revocation admin audit and data-scope checks" -WorkingDirectory $apiDir -Executable "go" -Arguments @("test", "./internal/compute", "-run", "Test(HTTPAuthScopeAndMetrics|StaticTokenRevocation|HTTPArtifactRetentionSweepRequiresAdminScope|HTTPArtifactRetentionSweepTenantProjectSiteScope|HTTPArtifactRetentionSweepArchiveTenantProjectSiteScope|ArtifactRetentionSweepArchivesCandidateWithConfiguredBackend|HTTPMutationAuditEventEnvelopeForJobCreate|HTTPJobCancelMutationAuditEvents|HTTPJobCancelMutationTenantProjectSiteScope|TimeoutSweepAndPagination|HTTPWorkerMutationRoutesRequirePost|HTTPJobCollectionRequiresDeclaredMethods|HTTPJobRoutesRequireDeclaredMethods|HTTPDeclaredMethodGuardsRunBeforeAuth|HTTPWorkerRegistrationMutationAuditEvents|HTTPWorkerJobMutationAuditEvents|HTTPWorkerArtifactCompletionMutationAuditEvents|HTTPWorkerJobFailureMutationAuditEvents|HTTPWorkerJobMutationTenantProjectSiteScope|HTTPResultExplanationAuditEvents|HTTPResultExplanationReviewPublishAuditEvents|HTTPResultExplanationMutationTenantProjectSiteScope|HTTPJobReadTenantProjectSiteScope|HTTPJobCreateMutationTenantProjectSiteScope|HTTPSimulationRegistryTenantProjectSiteScope|HTTPSimulationRegistryMutationTenantProjectSiteScope|HTTPSimulationCheckMutationTenantProjectSiteScope|HTTPSimulationRegistryMutationAuditEvents|HTTPDraftConfirmationTenantProjectSiteScope|HTTPDraftConfirmationMutationTenantProjectSiteScope|HTTPDraftConfirmationMutationAuditEvents|HTTPModelCatalogTenantProjectSiteScope|HTTPModelCatalogMutationTenantProjectSiteScope|HTTPModelCatalogPromotionTenantProjectSiteScope|HTTPModelRunTenantProjectSiteScope|HTTPBenchmarkRunTenantProjectSiteScope|HTTPBenchmarkRunMutationTenantProjectSiteScope|HTTPBenchmarkScheduleRunMutationTenantProjectSiteScope|HTTPArtifactDownloadTenantProjectSiteScope|EvidenceGovernanceUsesJobScopedModelCatalog|ProcessGraphEvidenceReferenceHonorsJobObjectScope)", "-count=1")
Invoke-Step -Name "governance route scope denial and mutation audit checks" -WorkingDirectory $apiDir -Executable "go" -Arguments @("test", "./internal/compute", "-run", "Test(ModelCatalogEndpoint|ModelCatalogStatusTransitionEndpoint|DefaultParameterSetPromotionPlanEndpoint|DefaultParameterSetPromoteApprovedEndpoint|BenchmarkCaseScheduleRunEndpoint|DraftConfirmationPromotionEndpoint|ContractValidationEndpoint|SimulationCheckEndpointCreatesComputeJob|NewSystemEvidenceReferenceE2E|NewSystemResultExplanationResolvesEvidenceRefs)", "-count=1")
...
$report = [ordered]@{
    ...
    coverage_summary = [ordered]@{
        ...
        mutation_audit_events = "covered_for_job_create_job_cancel_job_timeout_worker_registration_worker_claim_worker_heartbeat_artifact_upload_worker_succeed_completion_worker_fail_completion_artifact_retention_delete_archive_result_explanation_draft_confirmation_draft_promotion_model_governance_simulation_check_and_simulation_registry_events"
        worker_mutation_http_method_guard = "covered_for_claim_heartbeat_artifact_upload_succeed_and_fail_routes"
        job_route_http_method_guard = "covered_for_job_collection_get_events_result_evidence_production_readiness_evidence_ref_cancel_and_result_explanation_routes"
        ...
        tenant_project_site_data_scope = "tenant_project_site_read_scope_covered_for_job_list_get_simulation_registry_get_draft_confirmation_get_plan_promotion_model_catalog_root_model_snapshots_model_run_get_job_filtered_list_benchmark_run_get_job_filtered_list_and_artifact_download; evidence_governance_model_catalog_selection_covered_for_evidence_package_and_production_readiness; evidence_ref_process_graph_object_scope_covered_for_job_scoped_resolution; mutation_scope_covered_for_model_catalog_registration_status_promote_benchmark_run_registration_explicit_simulation_registry_registration_direct_job_create_direct_job_cancel_direct_simulation_check_confirm_draft_record_draft_promotion_benchmark_schedule_run_job_create_artifact_retention_delete_archive_candidate_filtering_and_worker_claim_heartbeat_artifact_succeed_fail_completion_and_result_explanation_submit_review_publish; promotion_evidence_scope_covered_for_model_catalog_promotion_plan_and_promote_approved"
    }

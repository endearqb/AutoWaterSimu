...
$report = [ordered]@{
    ...
    coverage_summary = [ordered]@{
        ...
        mutation_audit_events = "covered_for_job_create_job_cancel_job_timeout_worker_registration_worker_claim_artifact_upload_worker_completion_artifact_retention_result_explanation_draft_confirmation_draft_promotion_model_governance_and_simulation_registry_events"

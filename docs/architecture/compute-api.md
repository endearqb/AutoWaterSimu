...
- This split does not change endpoint behavior, OpenAPI, auth scopes, contracts, database schema, PostgreSQL migrations, model governance public service methods, or public `Service` method signatures.

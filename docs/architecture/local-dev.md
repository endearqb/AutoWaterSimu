...
| `just check-security` | Runs token guard, scope denial, revocation, admin-scope, selected mutation audit, and model governance audit checks and writes `tmp/ci-evidence/security-smoke.json` |

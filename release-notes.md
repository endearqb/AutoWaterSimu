...
- 每次对外发布重要版本时，增加一个 `## vX.Y.Z - YYYY-MM-DD` 小节
- 按 “新增 / 变更 / 修复 / 运维” 等维度列出要点
- 对内部试验性改动，可以只在 PR 中说明，不必写入此处

## 最近变更示例

### 新增

- 初始集成 FastAPI 模板，搭建基础前后端脚手架。

---

下文为创建项目时所使用的 FastAPI 模板自身的历史变更记录，仅供参考，一般可以忽略。

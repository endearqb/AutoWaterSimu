...
7. `simulation.asm1slim.v1`、`simulation.asm1.v1` 与 `simulation.asm3.v1` 是当前独立 ASM job type；加入 UDM 前必须先补合同 fixture、worker run-job 测试、model snapshot 和 legacy parity。

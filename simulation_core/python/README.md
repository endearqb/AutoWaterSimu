...
- UDM Network v2 graph compiler, flow balance solver, passive/reaction node evaluator and `takacs_settling.v1` edge transport evaluator import surface；ODE/RHS assembly remains a later phase.
